...
//    Susun dari yang paling lama dipublikasikan ke yang paling baru, supaya
//    artikel terbaru selalu muncul di bawah (paling "segar" saat dibaca).
...
export const ARTICLES: Article[] = [
  // ===== Artikel published, diurutkan kronologis (lama → baru) =====
  {
  ...
  // ===== Draft (published: false) — dikumpulkan di akhir, tidak muncul di index =====
  {
