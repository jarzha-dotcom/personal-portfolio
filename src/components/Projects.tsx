...
export const Projects: React.FC<ProjectsProps> = ({ darkMode }) => {
  ...
  return (
    ...
    >
          ...
          <div className="md:col-span-4 order-last mt-5 md:mt-0">
            <div className="md:sticky md:top-24 space-y-4">
              ...
              >
                ...
                <ul className="space-y-1 mb-4">
                  {[
                    `${AVAILABLE_MODELS.length} model AI (Gemini + Antigravity Agent)`,
                    'Auto-failover ke model lain kalau kena limit',
      ...
      {/* Project Detail Modal — pakai Portal supaya fixed ke viewport, sama seperti AI Chatbot Modal */}
      {activeModalProject && (
        <Portal>
          <div
            className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"
