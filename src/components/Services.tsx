    ...
    const services = [
        {
            ...
            description:
                'Pembuatan game berbasis web/mobile dengan arsitektur event-driven realtime, lobby room code, reconnect recovery, bot AI adaptif, kustomisasi tema 3D, dan audio synthesizer (seperti B-Games).',
            features: ['WebSockets & Event-Driven', 'Room Code & Reconnect', 'Tema 3D & Haptic Audio', 'Guest + Cloud Auth Sync'],
            color: 'amber',
        },
        {
            icon: <GraduationCap className="w-6 h-6" />,
            title: 'Aplikasi Edukasi & Gamifikasi Interaktif',
            description:
                'Pengembangan app edukasi interaktif dengan Flashcard 3D, Text-to-Speech (TTS) natural dwibahasa (ID/EN), kuis suara, gamifikasi bintang reward, dan mode full-offline PWA (seperti Rajendra Pintar).',
            features: ['Flashcard 3D & Kuis Ceria', 'TTS Dwibahasa Natural', 'Full Offline PWA Cache', 'Gamifikasi Bintang & Audio'],
            color: 'teal',
        },
        {
        ...
        },
        {
            ...
            title: 'AI Chatbot & Autonomous Agent',
            description:
                'Chatbot AI interaktif 2-arah (Teks & Suara) serta Autonomous Agent (Google Antigravity Interactions API) untuk generate dokumen RAB/Riset instan, lead generator WhatsApp, dan multi-LLM auto-failover.',
            features: ['Antigravity Agent & Tool Calling', 'Suara 2-Arah (STT + TTS)', 'Otomasi Dokumen RAB/Riset', 'Multi-LLM Zero-Downtime'],
            color: 'purple',
        },
    ];
    ...
    const pricingTiers = [
        {
            ...
            title: 'Landing Page',
            price: 'Rp 800rb',
            desc: 'Satu halaman responsif untuk personal branding atau promosi produk/jasa.',
        },
        {
            icon: <LayoutDashboard className="w-5 h-5" />,
            title: 'Company Profile / Web App Sederhana',
            price: 'Rp 2,5jt',
            desc: 'Multi-halaman profil bisnis dengan desain modern, katalog, & form terintegrasi.',
        },
        {
            icon: <Bot className="w-5 h-5" />,
            title: 'AI Chatbot & Virtual Agent',
            price: 'Rp 1,5jt',
            desc: 'Chatbot AI cerdas + Suara 2-arah + Autonomous Agent + WhatsApp lead generator.',
        },
        {
            icon: <FileSpreadsheet className="w-5 h-5" />,
            title: 'Web App & Dashboard Custom',
            price: 'Rp 6jt',
            desc: 'Dashboard operasional, sistem inventaris, atau tools bisnis terintegrasi database.',
        },
        {
            icon: <Smartphone className="w-5 h-5" />,
            title: 'Aplikasi Mobile & PWA',
            price: 'Rp 6jt',
            desc: 'Aplikasi Android/iOS (React Native/Capacitor) dengan offline cache & push notif.',
        },
        {
            icon: <Gamepad2 className="w-5 h-5" />,
            title: 'Game Realtime & Platform Interaktif',
            price: 'Rp 12jt',
            desc: 'Game online multiplayer dengan backend WebSockets, room matchmaking, & bot AI.',
        },
    ];
