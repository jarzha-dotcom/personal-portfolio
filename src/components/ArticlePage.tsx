...
export const ArticlePage: React.FC<ArticlePageProps> = ({ darkMode }) => {
  ...
  return (
    <>
      <ReadingProgress />
      <article className="relative pt-28 md:pt-32 pb-16 md:pb-24 overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <ShareButtons darkMode={darkMode} url={articleUrl} title={article.title} />
          </div>
          ...
          <div className="flex items-center justify-center gap-3 my-14" aria-hidden="true">
            <span
